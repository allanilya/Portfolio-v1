    ...
    <section className="min-h-screen flex flex-col items-center justify-center px-4 py-20">
      <div className="max-w-4xl w-full text-center">
        ...
        <div className="mb-8 flex justify-center">
          <div className="relative w-48 h-48 rounded-full overflow-hidden bg-gradient-to-br from-blue-600 to-purple-600">
            {/*
              To add your photo:
              1. Add your image file to /public/ folder (e.g., profile.jpg)
              2. Adjust the 'transform: scale()' value below to zoom in/out
                 - scale(1.0) = no zoom (100%)
                 - scale(1.5) = zoomed in to 150%
                 - scale(0.8) = zoomed out to 80%
              3. Adjust 'objectPosition' to reposition the image
                 - 'center center' = centered (default)
                 - 'center top' = centered horizontally, aligned to top
                 - '50% 30%' = custom positioning
            */}
            <img
              src="/Users/Allan/Portfolio/profilepic.jpeg"
              alt="Allan Ilyasov"
